...
let choreList = "Vaccum Upstairs,Vaccum Downstairs, Vaccum Commonroom, Upstairs Trash, Downstairs Trash, Front Stairs, Back Stairs, Bathroom Mirrors and Sink, Bathroom Showers and Toilet,Basement, Tables, Windows/Dusting"
let studentArray = studentNames.split(",")
let choreArray = choreList.split(",")
let twoPersonChore = choreArray[choreArray.length - 3]
let counter = 0
